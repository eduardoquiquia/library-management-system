...
public class MainControlador {
    ...
    private void abrirLibros() {
        abrirVentana("/com/biblioteca/vistas/Lector/LibroVista.fxml", "Gestión de Libros");
    }

    @FXML
    private void abrirPrestamos() {
        abrirVentana("/com/biblioteca/vistas/Lector/PrestamoVista.fxml", "Gestión de Préstamos");
    }
